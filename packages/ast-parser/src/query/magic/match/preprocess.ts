...
> = Selectors extends [infer Selector, ...infer Rest]
    ? Selector extends { type: "wildcard"; } | { type: "class"; } | { type: "has"; }
        ...
        : Selector extends { type: "identifier";
            value: any; }
            ? PatchMeta<
                SelectorAcc,
                "identifier",
            ...
            > extends infer PatchRes
                ? PatchRes extends MetaAcc
                    ...
                    : NeverError<PatchRes>
                : never
            : Selector extends { type: "attribute";
                name: any; }
                // TODO: add support for nested fields narrowing
                ? Selector["name"] extends `${string}.${string}`
                    ? PreprocessCompoundSelector<Rest, SelectorAcc, AST, Acc>
                    : Selector extends { operator: any;
                        value: any; }
                        ? Selector["value"] extends { type: "literal";
                            value: any; }
...
>
    ...
    | { type: "descendant"; }
        ...
        | { type: "class"; }
        | { type: "has"; }
            ? PreprocessSelector<{ type: "compound";
                selectors: [T]; }, SelectorAcc, AST>
            : T extends { type: "compound";
                selectors: any; }
                ? {
                    type: "and";
