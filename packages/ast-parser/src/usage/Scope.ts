...
import { isFunctionScopeBoundary } from "../util";
...
export enum ScopeBoundarySelector {
    Function = ScopeBoundary.Function as const,

    Block = (ScopeBoundarySelector.Function as const) | (ScopeBoundary.Block as const),
    InferType = ScopeBoundary.ConditionalType as const,
    Type = (ScopeBoundarySelector.Block as const) | (ScopeBoundary.Type as const),
}
